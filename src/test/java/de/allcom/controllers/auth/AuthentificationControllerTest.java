...
class AuthentificationControllerTest {
    ...
    void testLogin() {
        ...
        when(authentificationService.login(any(AuthentificationRequestDto.class), any(HttpServletResponse.class)))
                .thenReturn(expectedResponse);

        AuthentificationResponseDto responseActual = authentificationController.login(authRequest, response);
